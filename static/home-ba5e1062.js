...
$_mod.def("/marko-demo$1.0.0/src/pages/home/hello", function(require, exports, module, __filename, __dirname) { module.exports = function(name) {
    return 'Hello ' + name + ' !';
}
});
$_mod.def("/marko-demo$1.0.0/src/pages/home/client", function(require, exports, module, __filename, __dirname) { var hello = require('/marko-demo$1.0.0/src/pages/home/hello'/*'./hello'*/);
...
$_mod.def("/marko$4.9.2/src/components/boot", function(require, exports, module, __filename, __dirname) { if (window.$initComponents) window.$initComponents();

});
$_mod.run("/marko$4.9.2/src/components/boot");