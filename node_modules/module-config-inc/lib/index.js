...
module.exports = function config(moduleRef, callback) {
    ...
    cacheKey = utils.generateCacheKey(modRoot);
    ...
    if (response && response.code === 0) {
        ...
        utils.registerAndCacheConfig(cacheKey, configObject);

        return configObject;
    }
    else {
        console.error('[ERROR]', response ? response.output : 'Unknown config error');
    }
...
module.exports.registerConfig = utils.registerAndCacheConfig;
