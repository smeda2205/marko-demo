...
MessageElement.prototype.postProcess = function(definitions) {
  ...
  if (part.$element) {
    ...
    for (i = 0; part = this.children[i]; i++) {
      ...
      if (typeof this.parts[part.$name] !== 'string') {
...
function createParser(type) {
  ...
  if (type === 'fast') {
    ...
    //   'http://www.Dummy.com': 'xmlns:tns',
    //   'http://www.Dummy.com/Name/Types': 'xmlns:n',
    //   'http://www.Dummy.com/Common/Types': 'xmlns:c'
    ...
    parser.on('startNode', function(elem, attr, uq, str, tagend) {
      ...
      // console.log('----------->', elem, attr ? attr() : undefined);
      var attributes = attr ? attr() : {};
      attributes = typeof attributes === 'boolean' ? {} : attributes;
      parser.onopentag({
        name: elem,
