...
exports.inspectCached = function (path, requireHandler, lassoContext, config) {
    ...
    function readSource() {
        ...
        return streamToString(stream).then(_src => {
            src = _src;
            return src;
        });
    }
    ...
    function buildCacheKeyFromFingerprint() {
        return new Promise((resolve, reject) => {
            ...
            fingerprintStream.on('fingerprint', function (_fingerprint) {
            ...
            stream.on('error', reject).pipe(fingerprintStream);
        });
    }

    return requireHandler.getLastModified().then(_lastModified => {
