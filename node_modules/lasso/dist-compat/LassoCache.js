...
LassoCache.prototype = {
    ...
    getLassoPageResult(cacheKey, options) {
        var _this2 = this;

        return _asyncToGenerator(function* () {
            return _this2.lassoPageResultCache.get(cacheKey, options);
        })();
    },

    getBundleMappings(id, builder) {
        var _this3 = this;

        return _asyncToGenerator(function* () {
            return _this3.bundleMappingsCache.get(id.toString(), { builder });
        })();
    },

    getLassoedResource(path, builder) {
        var _this4 = this;

        return _asyncToGenerator(function* () {
            return _this4.lassoedResourcesCache.get(path, { builder });
        })();
    },

    getDependencyFingerprint(cacheKey, lastModified, builder) {
        var _this5 = this;

        return _asyncToGenerator(function* () {
            return _this5.dependencyFingerprintsCache.get(cacheKey, {
                lastModified,
                builder
            });
        })();
