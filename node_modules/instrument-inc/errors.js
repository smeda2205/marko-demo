...
var logger = require('logging-inc').logger('instrument-inc/errors');
/**
 *  Params:
...
var RuntimeError = module.exports.RuntimeError = function RuntimeError() {
    ...
    Object.defineProperty(this, 'message', {
        get: function get() {
            return this.errorObj.message + (this.error ? ', original error: ' + this.error.message : '');
        }
    });
    ...
    this.type = options.error && options.error.type || options.type || 'error';
