...
Logger.prototype = {
    ...
    publishTo: function (emitter, topic) {
        Assert.ok(emitter, 'Emitter should not be undefined');
        Assert.ok(topic, 'Topic should not be undefined');
    ...
    createTransaction: function createTransaction(type, name, status, data, next) {
        ...
        nsutils.run(function nsutilRun() {
