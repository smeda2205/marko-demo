...
objutil.extend(Transaction, Activity, {
    ...
    flush: function () {
        if (this.messageClass !== MessageClass.TRANSACTION_END) {
            ...
            // if master, setup flush timeout
            if (!this.parentEventId) {
                this.autoFlushTimer = setTimeout(function unfinishedTxTimeout() {
                    this.complete('UNFINISHED');
                    this.autoFlushTimer = undefined;
                }.bind(this), nsutils.getValue(constants.RELEASE_TIMEOUT) || 25000);
            }
    ...
    _doComplete: function () {
        ...
        this.autoFlushTimer && clearTimeout(this.autoFlushTimer);
        this.autoFlushTimer = undefined;
    },
