...
module.exports.isChunkedResponse = function (res) {
    if (res && res.headers && isValidContentType(res.headers) &&
        res.body) {
        return res.body.data ? true : false;
    } else {
        return false;
    }
};

module.exports.isTrackingResponse = function (res) {
    return res && res.body && (TRACKING_DATA === res.body.id || TRACKING === res.body.id);
};

module.exports.isEpResponse = function (res) {
    return res && res.body && (EP_DATA === res.body.id || EP === res.body.id);
};
