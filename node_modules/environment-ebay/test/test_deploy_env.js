...
describe('DEPLOY_ENV', function () {
    ...
    it('Default|Dev', function () {
        ...
        assert.equal(environment.isNotPreProd(), true);
        assert.equal(environment.isNotProd(), true);
        assert.equal(environment.isNotLnp(), true);
        ...
        assert.equal(environment.isPreProd(), false);
        assert.equal(environment.isProd(), false);
        assert.equal(environment.isSecure(), false);
        assert.equal(environment.isLnp(), false);
    ...
    it('Lnp', function () {
        ...
        assert.equal(environment.isNotPreProd(), true);
        assert.equal(environment.isNotProd(), true);
        assert.equal(environment.isNotLnp(), false);
        ...
        assert.equal(environment.isProd(), false);
        assert.equal(environment.isSecure(), false);
        assert.equal(environment.isLnp(), true);
    ...
    it('SECURE', function () {
        ...
        assert.equal(environment.isProd(), true);
        assert.equal(environment.isNotLnp(), true);
        assert.equal(environment.isSecure(), true);
